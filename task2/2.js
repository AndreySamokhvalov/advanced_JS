...
const initialData = [
  {
    ...
    reviews: [
      {
        id: Date.now(),
        text: "Пушка, а не телефон.",
      },
      {
        id: Date.now(),
        text: "Камера на высоте, типичный айфон).",
      },
    ],
  },
  {
    ...
    reviews: [
      {
        id: Date.now(),
        text: "Красивый, игоровой, но не внушает довверия.",
      },
    ],
  },
  {
    ...
    reviews: [
      {
        id: Date.now(),
        text: "Можно прокачать весь подъезд одним нажатием кнопки! Супер).",
      },
    ],
  },
];
  ...
  buttons[i].addEventListener("click", () => {
    ...
    try {
      if (text.length < 10 && text.length > 500) {
        throw new Error("внесите коррективы в текст");
      }
